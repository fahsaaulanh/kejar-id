<div class="modal fade" id="add-ma">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="saveForm" action="{{ URL('admin/curriculum/schools/'.$school['id'].'/assessment-groups/'.$assessmentGroupId.'/subject/'.$subject['id'].'/'.$grade.'/assessment') }}" method="post" enctype="multipart/form-data">
