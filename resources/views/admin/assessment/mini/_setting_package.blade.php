<div class="modal fade" id="setting_pack">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ URL('admin/curriculum/schools/'.$school['id'].'/assessment-groups/'.$assessmentGroupId.'/subject/'.$subject['id'].'/'.$grade.'/assessment/'.$assessments[0]['id']) }}" method="post" enctype="multipart/form-data">
