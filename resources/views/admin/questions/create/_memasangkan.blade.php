<div class="modal fade" id="create-memasangkan">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group ck-height-9 ckeditor-list">
                        ...
                        <textarea class="textarea-field editor-field" name="question" placeholder="Ketik keterangan soal" required></textarea>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="ckeditor-group ckeditor-list mb-3">
                                        <textarea name="answer[statement][{{ $i }}]" class="editor-field" placeholder="Ketik pernyataan {{ $i + 1 }}" ck-type="memasangkan"></textarea>
                                        <div class="ckeditor-btn-group ckeditor-btn-1 d-none">
                                            <button type="button" class="bold-btn" title="Bold (Ctrl + B)">
                                                <i class="kejar-bold"></i>
                                            </button>
                                    ...
                                    <div class="ckeditor-group ckeditor-list">
                                        <textarea name="answer[setstatement][{{ $i }}]" class="editor-field" placeholder="Ketik pasangan pernyataan {{ $i + 1 }}" ck-type="memasangkan"></textarea>
                                        <div class="ckeditor-btn-group ckeditor-btn-1 d-none">
                                            <button type="button" class="bold-btn" title="Bold (Ctrl + B)">
                                                <i class="kejar-bold"></i>
                                            </button>
