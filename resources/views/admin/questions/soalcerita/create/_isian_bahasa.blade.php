<div class="modal fade modal-large" id="create-isian-bahasa">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <table class="answer-list-table-ib" data-type="isian-bahasa">
                            ...
                            <tr>
                                <td colspan="2">
                                    <input type="hidden" name="answer[0]">
                                    <div contenteditable="true" class="answer-field disable-editor" placeholder="Ketik alternatif jawaban 1"></div>
                                </td>
                            </tr>
                        </table>
