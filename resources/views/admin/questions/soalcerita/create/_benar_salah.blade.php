<div class="modal" id="create-benar-salah">
    <div class="modal-dialog modal-fix">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('/admin/'. $game['uri'] . '/stages/' . $stage['id'] . '/rounds/' . $round['id'] . '/questions') }}" method="POST" id="benar-salah-form">
                    @csrf
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" onclick="document.getElementById('benar-salah-form').submit();">Simpan</button>
            </div>
        </div>
    </div>
</div>
