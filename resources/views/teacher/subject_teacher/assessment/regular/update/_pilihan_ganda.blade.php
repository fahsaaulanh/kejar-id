<div class="modal fade" id="edit-pilihan-ganda">
        <div class="modal-dialog  modal-fix" role="document">
            <form onsubmit="event.preventDefault(); editQuestion('{{$assessmentGroupId}}', '{{$subject['id']}}', '{{$grade}}', '{{$assessments[0]['id']}}')">
                @csrf
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group ck-height-9 ckeditor-list">
                            <label>Soal</label>
                            <textarea id="question2" class="textarea-field ckeditor-field" name="question" placeholder="Ketik soal" required></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <table class="answer-list-table-pg" data-type="pilihan-ganda" id="table_edit_answer">

                            </table>
                            <button id="editplus" class="btn btn-add border-0 pl-0 add-btn" type="button" data-type="pilihan-ganda" onclick="addChoice(event, 'table_edit_answer')">
                                <i class="kejar-add"></i> Tambah Pilihan Jawaban
                            </button>
                        </div>
                        <div class="form-group ck-height-9 ckeditor-list">
                            <label>Pembahasan</label>
                            <textarea id="explanation2" class="textarea-field ckeditor-field" name="explanation" placeholder="Ketik pembahasan"></textarea>
                            <div class="ckeditor-btn-group ckeditor-btn-1 d-none">
                                <button type="button" class="bold-btn" title="Bold (Ctrl + B)">
                                    <i class="kejar-bold"></i>
                                </button>
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="col-12 text-center mt-3" id="LoadingAssess2" style="display:none">
