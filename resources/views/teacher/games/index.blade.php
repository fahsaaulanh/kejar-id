    ...
    <div class="row dashboard">
        <div class="col-12">
            ...
            <div class="content-body">
                <div class="card-deck">
                    <a href="{{ url('teachers/games/obr/classes') }}" class="card">
                    ...
                    <a href="{{ url('teachers/games/katabaku/classes') }}" class="card">
                    ...
                    <a href="{{ url('teachers/games/vocabulary/classes') }}" class="card">
