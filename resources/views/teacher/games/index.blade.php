        ...
        <div class="row dashboard">
            <div class="col-12">
                ...
                <div class="content-body">
                    <div class="card-deck">
                        <a href="{{ url('/teachers/games/obr/class') }}" class="card">
                        ...
                        <a href="{{ url('/teachers/games/katabaku/class') }}" class="card">
                        ...
                        <a href="{{ url('/teachers/games/vocabulary/class') }}" class="card">
