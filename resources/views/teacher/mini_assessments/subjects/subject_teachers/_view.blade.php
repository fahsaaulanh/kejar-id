...
<div class="modal fade bd-example-modal-md" id="ma-validation">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <form action="{{ URL('teacher/mini-assessment/validation') }}" method="post">
                @csrf
                <div class="modal-body">
                    <div class="row mt-5">
                        <div class="col-12">
                            <input type="hidden" name="id" value="" id="ma-id">
                            <p>Tandai bahwa paket soal beserta kunci jawaban sudah divalidasi.</p>
                        </div>
                    </div>
                </div>
