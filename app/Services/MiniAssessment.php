...
class MiniAssessment extends Service
{
    ...
    public function assessmentQuestion($assessmentId)
    {
        $response = $this->get('/libraries/assessments/'.$assessmentId.'/questions');

        return $this->showResponse($response);
    }

    public function assessmentDetail($assessmentId)
    {
        $response = $this->get('/libraries/assessments/'.$assessmentId);

        return $this->showResponse($response);
    }

    public function assessmentUpdate($assessmentId, $payload)
    {
        $response = $this->patch('/libraries/assessments/'.$assessmentId, $payload);
